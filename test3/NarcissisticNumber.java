...
public class NarcissisticNumber {
    public static void main(String[] args) {
        ...
        // num3存放“i*i*i+j*j*j+k*k*k”； a用来记录水仙花的数目
        int num3, a = 0;

        System.out.print(num + "位的的水仙花数有：");

        //num2用来遍历n位的所有数据
        for (int num2 = (int) Math.pow(10.0, (double) (num - 1)); num2 < (int) Math.pow(10.0, (double) (num)); num2++) {

            num3 = jisuan(num2, num);
        ...
        if (a == 0) {
            System.out.println("\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b没有水仙花数!");
            return;
        }
        System.out.println("\n共有" + a + "个水仙花数!");
    }
